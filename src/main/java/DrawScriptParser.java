...
public class DrawScriptParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, ID=3, N=4, COLOR=5, WS=6;
	public static final int
		RULE_program = 0, RULE_header = 1, RULE_value = 2, RULE_delimiter = 3;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "header", "value", "delimiter"
		};
	}
	...
	public static class HeaderContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DrawScriptListener ) ((DrawScriptListener)listener).enterHeader(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DrawScriptListener ) ((DrawScriptListener)listener).exitHeader(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DrawScriptVisitor ) return ((DrawScriptVisitor<? extends T>)visitor).visitHeader(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final HeaderContext header() throws RecognitionException {
		...
		try {
			...
			match(T__0);
			setState(18);
			((HeaderContext)_localctx).val = value();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DelimiterContext delimiter() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_delimiter);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(22);
